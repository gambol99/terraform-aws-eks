...
| <a name="input_enable_ebs_csi_pod_identity"></a> [enable\_ebs\_csi\_pod\_identity](#input\_enable\_ebs\_csi\_pod\_identity) | Indicates if we should enable pod identity for the EBS CSI | `bool` | `false` | no |
| <a name="input_enable_karpenter_pod_identity"></a> [enable\_karpenter\_pod\_identity](#input\_enable\_karpenter\_pod\_identity) | Indicates if we should enable pod identity for Karpenter | `bool` | `false` | no |
| <a name="input_enable_lb_controller_pod_identity"></a> [enable\_lb\_controller\_pod\_identity](#input\_enable\_lb\_controller\_pod\_identity) | Indicates if we should enable pod identity for the Load Balancer Controller | `bool` | `false` | no |
